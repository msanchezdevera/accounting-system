...
import (
	...
	transaction "accounting/api/transaction"
	errors "accounting/pkg/errors"
	model "accounting/pkg/model"
	reflect "reflect"
)
...
func (m *MockTransactionService) Create(create *transaction.CreateTransaction) (*model.Transaction, errors.Error) {
	m.ctrl.T.Helper()
